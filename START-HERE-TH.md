...
## ระบบเพิ่มเติมในชุดล่าสุด
หลังรัน 04-order-numbers.sql ให้รัน 05-analytics.sql และ 06-accounting.sql ตามลำดับ และอ่าน UPDATE-ACCOUNTING-TH.md สำหรับตั้ง CRON_SECRET เพื่อเปิดวางบิลรายวัน
