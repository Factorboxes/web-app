> อัปเดตล่าสุด: เพิ่มไอคอนเว็บแอปและหน้า `/install` สำหรับ Android / iPhone พร้อมลิงก์และ QR Code ดู [คู่มือ PWA](UPDATE-PWA-TH.md) ไม่ต้องรัน SQL เพิ่ม

> อัปเดตล่าสุด: หน้าเข้าสู่ระบบพื้นส้ม การ์ดสีขาว ขนาดพอดีมือถือ พร้อมจดจำการเข้าสู่ระบบ อ่าน [UPDATE-MOBILE-LOGIN-TH.md](UPDATE-MOBILE-LOGIN-TH.md)
